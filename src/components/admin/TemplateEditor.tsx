...
import { Smartphone, Tablet, Watch, Laptop, Loader2, Save, X, Upload, Sparkles, ChevronDown, Layout, Target } from 'lucide-react';
  ...
  const handleSave = async () => {
    ...
    try {
      await updateCustomDevice({
        ...device,
        ...formData,
        name: formData.model, // Automatically generate name (just model)
      });
      onSave();
    } catch (err) {
